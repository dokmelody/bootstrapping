...
Dok programs are preferably developed using progressive refinements from high-level code to low-level code, in particular following an Aspect Oriented Programming (AOP) approach:
