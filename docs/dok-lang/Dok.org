...
#+END_SRC
** Overriding
Type variants can override properties and methods of parent type like in normal object-oriented languages. Also types of the methods can be redefined during overriding (see [[#type_conformance]]).
...
** Anonymous actions
   ...
   :END:
Anonymous actions are like a [[#anonymous-function]] but they can change the variables of their lexical-scope and the properties of ~self~ object.
