...
The Knil schema and queries can be high level and inefficient specifications that can be optimized in the final phases of application development. So the majority of these chapters are about clear specification of database semantic.
