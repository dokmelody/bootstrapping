...
- every tuple inside a Knil table is an entity and every foreign key pointing to is for sure a weak reference (i.e. for sure the first tuple is not part of the second) 
